...
The library primarily serves the needs of the Regus Core project but provides additional functionality for the benefit of the wider Regus ecosystem.
...
* **Relevance Arguments:**
    The relevance of the new functionality for the Regus ecosystem should be argued by outlining clear use cases.
...
The Contributor Workflow & Peer Review in libsecp256k1 are similar to Regus Core's workflow and review processes described in its [CONTRIBUTING.md](https://github.com/RegusCrypto/Regus/blob/master/CONTRIBUTING.md).
...
* Use `secp256k1_memcmp_var` instead of `memcmp` (see [#823](https://github.com/RegusCrypto/secp256k1/issues/823)).
